...
//1 fiyatı 30 ile 100 arasında kaç adet ürün var?
var count = 0;
...
console.log("1 ) Fiyatı 30 ile 100 arasında olan ürün sayısı: " + count);



//2 ismi a harfi ile başlayan ürünleri console a yazdır
var productsWithA = [];
for (var i = 0; i < products.length; i++) {
    var product = products[i];
    if (product.name.charAt(0).toLowerCase() === 'a') {
        productsWithA.push(product);
    }
}
// Konsola yazdırma 
console.log("2) İsmi 'A' harfi ile başlayan ürünler:");
for (var j = 0; j < productsWithA.length; j++) {
    console.log(productsWithA[j].name);
}



//3 ismi a harfi ile BİTEN ürünleri console a yazdır
var productsWithAEnd = [];
for (var i = 0; i < products.length; i++) {
    var product = products[i];
    if (product.name.charAt(product.name.length - 1).toLowerCase() === 'a') {
        productsWithAEnd.push(product);
    }
}
//konsola yazdırma
console.log("3) İsmi 'A' harfi ile biten ürünler:");
for (var j = 0; j < productsWithAEnd.length; j++) {
    console.log(productsWithAEnd[j].name);
}

//4 id si 10 olan ürünün adını console a yazdır
for (var i = 0; i < products.length; i++) {
    var product = products[i];
    if (product.id === 10) {
        console.log("4) id si 10 olan ürünün adı: " + product.name);
    }
}

//5 discontinued false olan kaç ürün var
var count = 0;
for (var i = 0; i < products.length; i++) {
    var product = products[i];
...
console.log("5) Discontinued false olan ürün sayısı: " + count);
...
console.log("6) En pahalı ürünün adı: " + maxPriceProduct.name);

//7 en uccuz ürünün adını console a yazdır
...
console.log("7) En ucuz ürünün adı: " + minPriceProduct.name);
